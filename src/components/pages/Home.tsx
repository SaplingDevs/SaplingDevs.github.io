    ...
    <div className="animate-slide-up">
      ...
      <div id="main-section">
        <header className="grid gap-12 md:grid-cols-2 md:grid-rows-1 grid-cols-1 grid-rows-auto">
          ...
          {/* Animation */}
          <div className="md:block hidden row-span-5 md:row-span-6 md:hover:scale-[1.02] transition-all duration-500 hover:scale-100 bg-[url('/rtx.png')] bg-cover bg-center rounded-3xl">
