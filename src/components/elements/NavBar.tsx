  ...
  return (
    <div className="w-full h-[70px] sticky top-8 z-50">
      ...
      {menuOpen && (
        <div
          ref={menuRef}
          className="absolute top-[70px] w-full left-0 bg-zinc-900 text-white rounded-3xl z-50 mt-4 transition-all"
        >
          <NavElements className="flex flex-col space-y-8 p-6"/>
        </div>
      )}
    </div>
  );
